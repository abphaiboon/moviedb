...
<template>
    ...
    <BreezeGuestLayout
        ...
        v-bind:popular-movie="popularMovie"
    >
        <div
        ...
        >
            ...
            <p>
                Find information on your favorite movies! Please enter a movie
                name below.
            </p>
        </div>

        <BreezeValidationErrors class="mb-4 mt-4" />
        <div v-if="error" class="mb-4 mt-4 font-medium text-sm text-red-600">
            <div
                class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4"
                role="alert"
            >
                <p class="font-bold text-lg">Uh oh, something went wrong!</p>
